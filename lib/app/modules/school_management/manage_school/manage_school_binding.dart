...
import 'package:cambridge_school/app/modules/school_management/manage_school/manage_school_controller.dart';
import 'package:cambridge_school/app/modules/school_management/school_list/school_list_controller.dart';
import 'package:get/get.dart';

class ManageSchoolBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut<ManageSchoolController>(() => ManageSchoolController());
  }
}