...
class AdmissionFeeStructureWidget extends StatelessWidget {
  final AdmissionFeeStructureController controller =
      Get.put(AdmissionFeeStructureController());

  AdmissionFeeStructureWidget({super.key});
