...
import 'package:cambridge_school/app/modules/attendance/user_attendance_model.dart';
...
class AttendanceController extends GetxController {
   ...
   final selectedUserType = RxString('Student');
   final selectedClass = RxString('Class 1');
   ...
   Future<void> fetchUsers() async {
      ...
      try {
         ...
         if (selectedUserType.value == 'Student') {
            ...
            users.value = await rosterRepository.getAllUsersInUserRoster(
                selectedUserType.value.toLowerCase(), schoolId);
         }
         ...
         for (var user in users) {
            if (user.userAttendance == null) {
               ...
               user.userAttendance = user.userAttendance!.compact(today); // Compact the UserAttendance
            }
         }
         updateCounts();
      } catch (e) {
