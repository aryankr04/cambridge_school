...
class ReAdmissionFeeStructureWidget extends StatelessWidget {
  final ReAdmissionFeeStructureController controller =
  Get.put(ReAdmissionFeeStructureController());

  ReAdmissionFeeStructureWidget({super.key});
