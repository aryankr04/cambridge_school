...
class PendingApprovalScreen extends StatelessWidget {
        ...
        Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text(
                  "Class: ${userData.studentDetails?.className ?? 'N/A'}${userData.studentDetails?.sectionName ?? 'N/A'}",
                  style: Theme.of(context).textTheme.labelMedium,
                ),
                const SizedBox(width: MySizes.md),
                Text(
                  "Roll no: ${userData.studentDetails?.rollNo ?? 'N/A'}",
                  style: Theme.of(context).textTheme.labelMedium,
                ),
              ],
            ),
  ...
  List<Widget> _buildUserDataRows(BuildContext context, UserModel userData) {
    return [
      _buildDataRow(context, "Name:", userData.name),
      _buildDataRow(context, "Email:", userData.email),
      _buildDataRow(context, "Mobile No:", userData.phoneNumber),
      _buildDataRow(context, "Nationality:", userData.nationality),
      _buildDataRow(context, "Date of Birth:", userData.dob.toString()),
      _buildDataRow(context, "Religion:", userData.religion),
      _buildDataRow(context, "Category:", userData.category),
      _buildDataRow(context, "Gender:", userData.gender),
      _buildDataRow(context, "Blood Group:", userData.bloodGroup),
      _buildDataRow(context, "Aadhaar No:", userData.aadhaarNo),
      _buildDataRow(context, "Address:", userData.address),
      _buildDataRow(context, "State:", userData.state),
