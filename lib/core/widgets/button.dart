      ...
      child: SizedBox(
        ...
        child: isOutlined
          ...
          style: OutlinedButton.styleFrom(
            foregroundColor: textColor ?? (isOutlined ? Colors.black : Colors.white),
            backgroundColor: Colors.transparent,
            side: borderSide ?? BorderSide(
                color: isDisabled?MyColors.borderColor:MyColors.subtitleTextColor , width: 1), // Border for outlined button
